...
assert(bfCount2 === INITIAL_BUSINESS_FUNCTIONS.length, `İkinci startuptan sonra hâlâ ${INITIAL_BUSINESS_FUNCTIONS.length} fonksiyon (gerçek: ${bfCount2})`);
